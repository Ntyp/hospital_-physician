...
app.post("/document", jsonParser, (req, res) => {
  ...
  connection.query(
    "INSERT INTO document (document_code,document_title,document_detail,document_file,document_version,document_status,created_at,hospital_id,created_by) VALUES (?,?,?,?,?,?,?,?,?)",
    [
      code,
      title,
      detail,
