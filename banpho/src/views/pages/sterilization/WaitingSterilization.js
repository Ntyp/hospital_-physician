...
const WaitingSterilization = () => {
    ...
    const rows = [
        createData('1', 'โรงพยาบาลส่งเสริมสุขภาพตำบลบางซ่อน', '2023-08-13', 'BPTH50141', ''),
        createData('2', 'โรงพยาบาลส่งเสริมสุขภาพตำบลลาดขวาง', '2023-08-13', 'BPTH50142', ''),
        createData('3', 'โรงพยาบาลส่งเสริมสุขภาพตำบลเกาะไร่', '2023-08-13', 'BPTH50143', ''),
        createData('4', 'โรงพยาบาลส่งเสริมสุขภาพตำบลสนามจันทร์', '2023-08-13', 'BPTH50144', ''),
        createData('5', 'โรงพยาบาลส่งเสริมสุขภาพตำบลบางกรูด', '2023-08-13', 'BPTH50145', '')
    ];
