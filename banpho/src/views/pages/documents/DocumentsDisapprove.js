...
const DocumentsDisapprove = () => {
    ...
    const rows = [
        createData('1', '2023-08-13', 'การเบิกเงิน', 'นายโชคดี มีชัย เจ้าหน้าที่รพ.สต.', 'เบิกเงินซื้อพัดลมครับ', 'ไม่อนุมัติ'),
        createData('2', '2023-08-13', 'การเบิกเงิน', 'นายโชคดี มีชัย เจ้าหน้าที่รพ.สต.', 'เบิกเงินซื้อพัดลมครับ', 'ไม่อนุมัติ'),
        createData('3', '2023-08-13', 'การเบิกเงิน', 'นายโชคดี มีชัย เจ้าหน้าที่รพ.สต.', 'เบิกเงินซื้อพัดลมครับ', 'ไม่อนุมัติ'),
        createData('4', '2023-08-13', 'การเบิกเงิน', 'นายโชคดี มีชัย เจ้าหน้าที่รพ.สต.', 'เบิกเงินซื้อพัดลมครับ', 'ไม่อนุมัติ')
    ];
